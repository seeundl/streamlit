...
if query:
    ...
    response = requests.get(f"https://naver-serch.vercel.app//search_api?query={query}", headers=headers)

    # response = requests.get(f"https://your-vercel-app-url.vercel.app/search_api?query={query}", headers=headers)
